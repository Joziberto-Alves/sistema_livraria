...
public class Biblioteca {
    ...
    public static Biblioteca createBiblioteca() {
        ...
        Livro livro1 = new Livro(1, "Memórias Póstumas de Brás Cubas", autor1, true, cadastrodata, dataatualização);
        Livro livro2 = new Livro(2, "Dom Casmurro", autor1, true, cadastrodata, dataatualização);
        Livro livro3 = new Livro(3, "Quincas Borba", autor1, true, cadastrodata, dataatualização);

        // Livros de Clarice Lispector (autor2)
        Livro livro4 = new Livro(4, "A Hora da Estrela", autor2, true, cadastrodata, dataatualização);
        Livro livro5 = new Livro(5, "Perto do Coração Selvagem", autor2, true, cadastrodata, dataatualização);
        Livro livro6 = new Livro(6, "Laços de Família", autor2, true, cadastrodata, dataatualização);

        // Livros de Fernando Pessoa (autor3)
        Livro livro7 = new Livro(7, "Livro do Desassossego", autor3, true, cadastrodata, dataatualização);
        Livro livro8 = new Livro(8, "Mensagem", autor3, true, cadastrodata, dataatualização);

        // Livros de Jorge Amado (autor4)
        Livro livro9 = new Livro(9, "Capitães da Areia", autor4, true, cadastrodata, dataatualização);
        Livro livro10 = new Livro(10, "Gabriela, Cravo e Canela", autor4, true, cadastrodata, dataatualização);
        Livro livro11 = new Livro(11, "Dona Flor e Seus Dois Maridos", autor4, true, cadastrodata, dataatualização);

        // Livros de Virginia Woolf (autor5)
        Livro livro12 = new Livro(12, "Mrs. Dalloway", autor5, true, cadastrodata, dataatualização);
        Livro livro13 = new Livro(13, "Ao Farol", autor5, true, cadastrodata, dataatualização);
        ...
        Biblioteca bliblioteca = new Biblioteca(livros, autores, emprestimos);
        return bliblioteca;
    }
